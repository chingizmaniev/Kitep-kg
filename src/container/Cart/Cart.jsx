                ...
                <>
                    ...
                    <div style={{ display: 'flex' }}>
                        ...
                        <div style={{ textAlign: 'start' }}>
                            ...
                            <p>Исправить это недоразумение очень просто: выберите в каталоге интересующий товар и нажмите кнопку «В корзину».</p>
                        ...
                        <div className="cart">
                            <Container>
                                ...
                                <div className="cart-makeOrder">
                                    ...
                                    <button className="makeOrder-btn" onClick={makeOrder, handleShow}>Оплатить</button>
                                </div>
